  ...
  const features = [
    {
      ...
      description:
        'Learn the robotic nervous system with ROS 2 architecture',
      link: '/docs/module-1-ros2',
    },
    {
      title: 'Digital Twins',
      description:
        'Explore Gazebo and Unity simulation environments',
      link: '/docs/module-2-digital-twin',
    },
    {
      title: 'NVIDIA Isaac AI',
      description:
        'Master robotics with GPU-accelerated AI capabilities',
      ...
      <div className="container">
        <div className="row">
          {features.map((feature, idx) => (
            <div
              key={idx}
              className="col col--12 col--6 col--4 margin-bottom--lg"
            >
              <div className="card shadow--md height--full">
